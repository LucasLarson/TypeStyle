...
class AboutViewController: UITableViewController {
  ...
  let cells: [UITableViewCell] = [
    ...
    AboutLabelTableViewCell(text: "TypeStyle is open source! It is written in Swift 5.0 and released under the GNU-GPL 3.0 license."),
    AboutButtonTableViewCell(text: "View Source", link: "https://github.com/ebelinski/typestyle"),
